...
<TabsPrimitive.Trigger
	...
	class={cn(
		...
		"data-active:bg-background data-active:text-foreground data-active:shadow-sm dark:data-active:border-border dark:data-active:bg-background dark:data-active:text-foreground data-active:ring-1 data-active:ring-border/60",
